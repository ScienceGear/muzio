...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (data) {
            ...
            const off = new EmbedBuilder().setDescription(`${emoji.custom_emoji.cross} | 247 Mode has been: \`Disabled\``).setColor(client.color);
            ...
            const on = new EmbedBuilder().setDescription(`${emoji.custom_emoji.tick} | 247 Mode has been: \`Enabled\``).setColor(client.color);
